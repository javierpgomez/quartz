...
function htmlToJsx(fp, tree) {
  try {
    return toJsxRuntime(tree, { Fragment, jsx: jsx5, jsxs: jsxs2, elementAttributeNameCase: "html" });
  } catch (e) {
...
function TagContent(props) {
  ...
  if (tag === "") {
    ...
    return /* @__PURE__ */ jsxs4("div", { class: "popover-hint", children: [
      /* @__PURE__ */ jsx9("article", { children: /* @__PURE__ */ jsx9("p", { children: content }) }),
      /* @__PURE__ */ jsxs4("p", { children: [
        "Found ",
        tags.length,
        " total tags."
      ] }),
      /* @__PURE__ */ jsx9("div", { children: tags.map((tag2) => {
        ...
        return /* @__PURE__ */ jsxs4("div", { children: [
          /* @__PURE__ */ jsx9("h2", { children: /* @__PURE__ */ jsxs4("a", { class: "internal tag-link", href: `./${tag2}`, children: [
            "#",
            tag2
          ] }) }),
          content2 && /* @__PURE__ */ jsx9("p", { children: content2 }),
          /* @__PURE__ */ jsxs4("p", { children: [
          ...
          /* @__PURE__ */ jsx9(PageList, { limit: numPages, ...listProps })
        ] });
      }) })
    ] });
  } else {
    ...
    return /* @__PURE__ */ jsxs4("div", { class: "popover-hint", children: [
      /* @__PURE__ */ jsx9("article", { children: content }),
      /* @__PURE__ */ jsxs4("p", { children: [
        pluralize(pages.length, "item"),
        " with this tag."
      ] }),
      /* @__PURE__ */ jsx9("div", { children: /* @__PURE__ */ jsx9(PageList, { ...listProps }) })
    ] });
  }
}
...
function NotFound() {
  return /* @__PURE__ */ jsxs6("article", { class: "popover-hint", children: [
    /* @__PURE__ */ jsx11("h1", { children: "404" }),
    /* @__PURE__ */ jsx11("p", { children: "Either this page is private or doesn't exist." })
  ] });
}
...
function ArticleTitle({ fileData, displayClass }) {
  ...
  if (title) {
    return /* @__PURE__ */ jsx12("h1", { class: `article-title ${displayClass ?? ""}`, children: title });
  } else {
    return null;
  }
}
...
function Darkmode({ displayClass }) {
  return /* @__PURE__ */ jsxs7("div", { class: `darkmode ${displayClass ?? ""}`, children: [
    /* @__PURE__ */ jsx13("input", { class: "toggle", id: "darkmode-toggle", type: "checkbox", tabIndex: -1 }),
    /* @__PURE__ */ jsx13("label", { id: "toggle-label-light", for: "darkmode-toggle", tabIndex: -1, children: /* @__PURE__ */ jsxs7(
      "svg",
      {
    ...
    /* @__PURE__ */ jsx13("label", { id: "toggle-label-dark", for: "darkmode-toggle", tabIndex: -1, children: /* @__PURE__ */ jsxs7(
      "svg",
      {
        ...
        xmlSpace: "preserve",
        children: [
          /* @__PURE__ */ jsx13("title", { children: "Dark mode" }),
          /* @__PURE__ */ jsx13("path", { d: "M96.76,66.458c-0.853-0.852-2.15-1.064-3.23-0.534c-6.063,2.991-12.858,4.571-19.655,4.571  C62.022,70.495,50.88,65.88,42.5,57.5C29.043,44.043,25.658,23.536,34.076,6.47c0.532-1.08,0.318-2.379-0.534-3.23  c-0.851-0.852-2.15-1.064-3.23-0.534c-4.918,2.427-9.375,5.619-13.246,9.491c-9.447,9.447-14.65,22.008-14.65,35.369  c0,13.36,5.203,25.921,14.65,35.368s22.008,14.65,35.368,14.65c13.361,0,25.921-5.203,35.369-14.65  c3.872-3.871,7.064-8.328,9.491-13.246C97.826,68.608,97.611,67.309,96.76,66.458z" })
        ]
      }
    ) })
  ] });
...
var Head_default = /* @__PURE__ */ __name(() => {
  function Head({ cfg, fileData, externalResources }) {
    ...
    return /* @__PURE__ */ jsxs8("head", { children: [
      ...
      /* @__PURE__ */ jsx14("meta", { charSet: "utf-8" }),
      /* @__PURE__ */ jsx14("meta", { name: "viewport", content: "width=device-width, initial-scale=1.0" }),
      /* @__PURE__ */ jsx14("meta", { property: "og:title", content: title }),
      /* @__PURE__ */ jsx14("meta", { property: "og:description", content: description }),
      cfg.baseUrl && /* @__PURE__ */ jsx14("meta", { property: "og:image", content: ogImagePath }),
      /* @__PURE__ */ jsx14("meta", { property: "og:width", content: "1200" }),
      /* @__PURE__ */ jsx14("meta", { property: "og:height", content: "675" }),
      /* @__PURE__ */ jsx14("link", { rel: "icon", href: iconPath }),
      /* @__PURE__ */ jsx14("meta", { name: "description", content: description }),
      /* @__PURE__ */ jsx14("meta", { name: "generator", content: "Quartz" }),
      /* @__PURE__ */ jsx14("link", { rel: "preconnect", href: "https://fonts.googleapis.com" }),
      /* @__PURE__ */ jsx14("link", { rel: "preconnect", href: "https://fonts.gstatic.com" }),
      css.map((href) => /* @__PURE__ */ jsx14("link", { href, rel: "stylesheet", type: "text/css", "spa-preserve": true }, href)),
...
function PageTitle({ fileData, cfg, displayClass }) {
  ...
  return /* @__PURE__ */ jsx15("h1", { class: `page-title ${displayClass ?? ""}`, children: /* @__PURE__ */ jsx15("a", { href: baseDir, children: title }) });
}
...
var ContentMeta_default = /* @__PURE__ */ __name(() => {
  function ContentMetadata({ cfg, fileData, displayClass }) {
    ...
    if (text) {
      ...
      return /* @__PURE__ */ jsx16("p", { class: `content-meta ${displayClass ?? ""}`, children: segments.join(", ") });
    } else {
      return null;
    }
  }
...
function Spacer({ displayClass }) {
  return /* @__PURE__ */ jsx17("div", { class: `spacer ${displayClass ?? ""}` });
}
...
import { jsx as jsx18, jsxs as jsxs9 } from "preact/jsx-runtime";
var defaultOptions8 = {
  layout: "modern"
};
function TableOfContents2({ fileData, displayClass }) {
  ...
  return /* @__PURE__ */ jsxs9("div", { class: `toc ${displayClass ?? ""}`, children: [
    /* @__PURE__ */ jsxs9("button", { type: "button", id: "toc", children: [
      /* @__PURE__ */ jsx18("h3", { children: "Table of Contents" }),
      /* @__PURE__ */ jsx18(
        "svg",
        {
          xmlns: "http://www.w3.org/2000/svg",
    ...
    /* @__PURE__ */ jsx18("div", { id: "toc-content", children: /* @__PURE__ */ jsx18("ul", { class: "overflow", children: fileData.toc.map((tocEntry) => /* @__PURE__ */ jsx18("li", { class: `depth-${tocEntry.depth}`, children: /* @__PURE__ */ jsx18("a", { href: `#${tocEntry.slug}`, "data-for": tocEntry.slug, children: tocEntry.text }) }, tocEntry.slug)) }) })
  ] });
}
...
function LegacyTableOfContents({ fileData }) {
  ...
  return /* @__PURE__ */ jsxs9("details", { id: "toc", open: true, children: [
    /* @__PURE__ */ jsx18("summary", { children: /* @__PURE__ */ jsx18("h3", { children: "Table of Contents" }) }),
    /* @__PURE__ */ jsx18("ul", { children: fileData.toc.map((tocEntry) => /* @__PURE__ */ jsx18("li", { class: `depth-${tocEntry.depth}`, children: /* @__PURE__ */ jsx18("a", { href: `#${tocEntry.slug}`, "data-for": tocEntry.slug, children: tocEntry.text }) }, tocEntry.slug)) })
  ] });
}
...
function ExplorerNode({ node, opts, fullPath, fileData }) {
  ...
  return /* @__PURE__ */ jsx19("li", { children: node.file ? (
    // Single file node
    /* @__PURE__ */ jsx19("li", { children: /* @__PURE__ */ jsx19("a", { href: resolveRelative(fileData.slug, node.file.slug), "data-for": node.file.slug, children: node.displayName }) }, node.file.slug)
    ...
    /* @__PURE__ */ jsxs10("div", { class: "folder-container", children: [
      ...
      /* @__PURE__ */ jsx19("div", { "data-folderpath": folderPath, children: folderBehavior === "link" ? /* @__PURE__ */ jsx19("a", { href: `${folderPath}`, "data-for": node.name, class: "folder-title", children: node.displayName }) : /* @__PURE__ */ jsx19("button", { class: "folder-button", children: /* @__PURE__ */ jsx19("p", { class: "folder-title", children: node.displayName }) }) }, node.name)
    ] }),
    /* @__PURE__ */ jsx19("div", { class: `folder-outer ${node.depth === 0 || isDefaultOpen ? "open" : ""}`, children: /* @__PURE__ */ jsx19(
      "ul",
      {
        style: {
        ...
        children: node.children.map((childNode, i) => /* @__PURE__ */ jsx19(
          ExplorerNode,
          {
            node: childNode,
            opts,
    ...
    return /* @__PURE__ */ jsxs11("div", { class: `explorer ${displayClass ?? ""}`, children: [
      /* @__PURE__ */ jsxs11(
        "button",
        {
          ...
          "data-tree": jsonTree,
          children: [
            /* @__PURE__ */ jsx20("h1", { children: opts.title }),
            /* @__PURE__ */ jsx20(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      /* @__PURE__ */ jsx20("div", { id: "explorer-content", children: /* @__PURE__ */ jsxs11("ul", { class: "overflow", id: "explorer-ul", children: [
        /* @__PURE__ */ jsx20(ExplorerNode, { node: fileTree, opts, fileData }),
        /* @__PURE__ */ jsx20("li", { id: "explorer-end" })
      ] }) })
    ] });
  }
...
function TagList({ fileData, displayClass }) {
  ...
  if (tags && tags.length > 0) {
    return /* @__PURE__ */ jsx21("ul", { class: `tags ${displayClass ?? ""}`, children: tags.map((tag) => {
      const display = `#${tag}`;
...
import { Fragment as Fragment3, jsx as jsx26 } from "preact/jsx-runtime";
...
import { Fragment as Fragment5, jsx as jsx29, jsxs as jsxs17 } from "preact/jsx-runtime";
...
var Breadcrumbs_default = /* @__PURE__ */ __name((opts) => {
  ...
  function Breadcrumbs({ fileData, allFiles, displayClass }) {
    if (options2.hideOnRoot && fileData.slug === "index") {
      return /* @__PURE__ */ jsx29(Fragment5, {});
    }
    ...
    return /* @__PURE__ */ jsx29("nav", { class: `breadcrumb-container ${displayClass ?? ""}`, "aria-label": "breadcrumbs", children: crumbs.map((crumb, index) => /* @__PURE__ */ jsxs17("div", { class: "breadcrumb-element", children: [
...
var config = {
  configuration: {
    ...
    ignorePatterns: ["private", "template", ".obsidian", "Templates/", "Notes2/", "Hide/"],
...
var PerfTimer = class {
  ...
  timeSince(evtName) {
    return chalk4.yellow(pretty(process.hrtime(this.evts[evtName ?? "start"])));
  }
};
