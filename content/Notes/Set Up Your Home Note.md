...
1. Go to the [[Maps/Home]] note. Check it out. 
...
Remember, the structure works *for you*, not the other way around (See [[Notes/Is LYT For Me]]). You can always just create thousands of notes without looking at the home note once. 

---
### Advanced steps
1. In the [[Maps/Home]] note, start customizing the Home MOCs to suit your personal needs. Less is more at the start of your journey. A bulleted list can be faster to work in (and easier to maintain) than a complicated table.
...
For more guidance on this, go to: [[Notes/Figuring out your Home MOCs]]